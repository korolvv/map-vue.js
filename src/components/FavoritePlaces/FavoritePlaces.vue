...
import FavoritePlace from '../FavoritePlace/FavorivePlace.vue'
import IButton from '../IButton/IButton.vue'
import { useModal } from '../../composables/useModal.js'
import { computed, ref } from 'vue'
import { useMutation } from '../../composables/useMutation.js'
import { updateFavoritePlace, deleteFavoritePlace } from '../../api/favorite-places/index.js'
...
<template>
  <div class="px-6 text-black">
    ...
    <slot name="list">
      <div v-if="items.length === 0 && !isPlacesLoading">The list is emply</div>
      <FavoritePlace
      ...
      <ConfirmationModal
        ...
        title="Do you want to delete this favorite place?"
      />
    </slot>
